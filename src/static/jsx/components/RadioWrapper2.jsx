...
class RadioWrapper2 extends React.Component{
  constructor(props){
    super(props);
  }
    ...
    return(
      <Grid container item
        ...
        <Grid item>
          ...
          <Typography className={classes.radiotext}>{this.props.text5}</Typography>
          <Typography className={classes.radiotext}>{this.props.text6}</Typography>
          <Typography className={classes.radiotext}>{this.props.text7}</Typography>
          <Typography className={classes.radiotext}>{this.props.text8}</Typography>
        </Grid>
      </Grid>
    );
  }
...
export default withStyles(styles)(RadioWrapper2);